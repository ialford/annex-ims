...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "annex_ims_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: "#{Socket.gethostname}.library.nd.edu" }

  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address: 'smtp.library.nd.edu',
    port: 25,
    # domain:               'library.nd.edu',
    # user_name:            '<username>',
    # password:             '<password>',
