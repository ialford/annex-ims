...
RSpec.describe CannedReport, type: :model do
  context 'validation' do
    it 'should be valid' do
      expect(CannedReport.find('shelf_report')).to be_valid
    end

    it 'should not be valid' do
      expect(CannedReport.find('')).to_not be_valid
    end
  end

  context 'load' do
    it 'should load the file' do
      report = CannedReport.find('shelf_report')
  ...
  context 'to_sql' do
    ...
    it 'should generate sql properly for a checkbox true (and a date range)' do
      ...
      report = CannedReport.find('item_ingest_and_consolidation')
    ...
    it 'should generate sql properly for a number field' do
      ...
      report = CannedReport.find('tray_fill')
